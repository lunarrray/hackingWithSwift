...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        currentAnswer.layer.cornerRadius = 20
    ...
    @objc func submitTapped( _ sender: UIButton){
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText){
            ...
            let vc = UIAlertController(title: "Wrong answer", message: "Please try again", preferredStyle: .alert)
            vc.addAction(UIAlertAction(title: "OK", style: .default, handler: wrongAnswer))
    ...
    func wrongAnswer(action: UIAlertAction){
        ...
        for button in activatedButtons {
            if letterButtons.contains(button){
                let index = letterButtons.firstIndex(of: button)
